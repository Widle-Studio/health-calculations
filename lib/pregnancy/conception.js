// Importing the contents of the `dates.json` file for use in conception calculations:
const scales = require('./dates.json');

/**
 * Calculates Conception days.
 *
...
function conception(date, scale) {
    ...
    if (scaleMatch) {
        ...
        let c = new Date(day1.setDate(day1.getDate() + 1));
...
// Exports the `conception` function to be used elsewhere:
