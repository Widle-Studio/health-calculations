...
function idealWeight(weight, weightType, height, heightType) {
    if (weightType === "Pound") {
        if (heightType === "Inches") {
            return (5 * (703 * (weight / (height * height))) + ((703 * (weight / (height * height))) / 5) * (height - 60)).toFixed(2);
        } else if (heightType === "Feet") {
            return (5 * (703 * (weight / ((height * 12) * (height * 12)))) + ((703 * (weight / ((height * 12) * (height * 12)))) / 5) * ((height * 12) - 60)).toFixed(2);
        } else if (heightType === "Meters") {
            return (5 * (703 * (weight / ((height * 39.37) * (height * 39.37)))) + ((703 * (weight / ((height * 39.37) * (height * 39.37)))) / 5) * ((height * 39.37) - 60)).toFixed(2);
        }
        else {
